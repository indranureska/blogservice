...
const USER_NOT_FOUND_MSG_KEY = "user.not.found"
const USER_NOT_FOUND_MSG_DEF_TEXT = "User not found"

const SERVICE_NOT_AVAILABLE_MSG_KEY = "service.not.available"
const SERVICE_NOT_AVAILABLE_MSG_DEF_TEXT = "Service is not available"

const DB_CONNECT_FAILED_MSG_KEY = "database.connection.failed"
const DB_CONNECT_FAILED_MSG_DEF_TEXT = "Database connection failed"
